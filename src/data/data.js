import {AiOutlineMenuUnfold, AiOutlineSchedule} from "react-icons/ai";
import {
    FaBookReader,
    FaChalkboardTeacher,
    FaClipboardCheck,
...
import {GiSandsOfTime, GiTeacher} from "react-icons/gi";
import {IoMdCalendar} from "react-icons/io";
import {FiUsers} from "react-icons/fi";
import {BiMailSend, BiMessageDetail, BiSolidReport, BiSolidUser} from "react-icons/bi";
...
import {BsDoorOpenFill, BsFillDoorOpenFill, BsFillJournalBookmarkFill, BsIntersect, BsTable} from "react-icons/bs";
import {ImBooks, ImStatsDots, ImUsers} from "react-icons/im";
import {VscFileSubmodule} from "react-icons/vsc";
import {IoTime} from "react-icons/io5"
import {PiStudent, PiStudentFill} from "react-icons/pi"
import {FaFileCircleExclamation, FaFileCircleXmark, FaUserGroup} from "react-icons/fa6";


export const SuperAdminSideBar = [
    {
        icon: HiOutlineViewGrid,
        heading: "super_admin_sidebar_dashboard",
        link: '/super/groups',
    },
    {
        icon: FaUserGraduate,
        heading: "super_admin_sidebar_student",
        link: '/super/student',
    },
    {
        icon: AiOutlineSchedule,
        heading: 'super_admin_sidebar_dekan',
        link: '/super/dekan'
    },
    {
        icon: AiOutlineSchedule,
        heading: 'super_admin_sidebar_dekanat',
        link: '/super/dekanat'
    },
    {
        icon: BsTable,
        heading: 'super_admin_sidebar_kafedra',
        link: '/super/kafedra'
    },
    {
        icon: MdSettings,
        heading: 'super_admin_sidebar_staff',
        link: '/super/staff'
    },
    {
        icon: MdOutlineSchool,
        heading: 'super_admin_sidebar_school',
        link: '/super/school'
    },
    {
        icon: FaCubes,
        heading: 'super_admin_sidebar_faculty',
        link: '/super/faculty'
    },
]
...
export const TeacherSideBar = [
    {
        icon: HiOutlineViewGrid,
        heading: "student_sidebar_menu",
        link: '/teacher/menu',
    },
    {
        icon: AiOutlineSchedule,
        heading: 'teacher_sidebar_statistics',
        link: '/teacher/statistics'
    },
    {
        icon: BsTable,
        heading: 'student_sidebar_time_table',
        link: '/teacher/table'
    },
    {
        icon: ImBooks,
        heading: 'teacher_sidebar_sciences',
        link: '/teacher/teacherscience'
    },
    {
        icon: BsFillJournalBookmarkFill,
        heading: 'teacher_sidebar_journal',
        link: '/teacher/journal'
    },
    {
        icon: BiSolidReport,
        heading: 'kafedra_sidebar_statement',
        link: '/teacher/statement'
    },
    {
        icon: VscFileSubmodule,
        heading: 'teacher_sidebar_files',
        link: '/teacher/files'
    },
    {
        icon: MdSettings,
        heading: 'student_sidebar_settings',
        link: '/teacher/settings'
    },
]


export const TeacherSideBarForKafedra = [
    {
        icon: HiOutlineViewGrid,
        heading: "student_sidebar_menu",
        link: '/teacher/menu',
    ...
    {
        icon: ImUsers,
        heading: 'teacher_sidebar_kafedra_dashboard',
        link: '/kafedra/dashboard'
    },
]
...
export const StudentSideBar = [
    ...
    {
        icon: FaBookReader,
        heading: "student_sidebar_sciences",
        link: '/student/sciences',
    },
    {
        icon: AiOutlineSchedule,
        heading: 'student_sidebar_statistics',
    ...
    },
    {
        ...
        heading: 'student_sidebar_results',
        link: '/student/results'
    },
    {
        icon: FaFileCircleXmark,
        heading: 'student_sidebar_retake',
        link: '/student/retake'
    },
    {
        icon: FaFileCircleExclamation,
        heading: 'student_sidebar_finals',
        link: '/student/finals'
    },
    {
        icon: MdMiscellaneousServices,
        heading: 'student_sidebar_service',
...
export const RektorSidebarData = [
    {
        icon: AiOutlineMenuUnfold,
        heading: "rektor_sidebar_menu",
        link: '/rektor/menu'
    },
    {
        icon: FaUserTie,
        heading: 'rektor_sidebar_rahbariyat',
        link: '/rektor/rahbariyat'
    },
    {
        icon: MdGroups,
        heading: 'rektor_sidebar_personnel',
        link: '/rektor/employees/'
    },
    {
        icon: FaUserGraduate,
        heading: 'rektor_sidebar_student',
        link: '/rektor/students/'
    },
    {
        icon: BsFillJournalBookmarkFill,
        heading: 'teacher_sidebar_journal',
    ...
    {
        icon: GiSandsOfTime,
        heading: 'rektor_sidebar_statisticsall',
        link: '/rektor/statistics/'
    },
    {
        icon: FaServer,
        heading: 'dekan_sidebar_arxiv',
        link: '/rektor/arxiv'
    },
];

export const KengashRaisiSidebarData = [
...
export const RektorChangeSidebarData = [
    {
        icon: AiOutlineMenuUnfold,
        heading: "rektor_sidebar_menu",
        link: '/rektor/menu'
    ...
    {
        icon: GiTeacher,
        heading: 'rektor_sidebar_teacher',
        link: '/rektor/teacher'
    },
    {
        icon: IoMdCalendar,
        heading: 'rektor_sidebar_staff',
        link: '/rektor/staff'
    },
    {
        icon: BsIntersect,
        heading: 'kafedra_sidebar_teachers_menu',
        link: '/rektor/section'
    },
];


export const DekanSidebarData = [
    {
        icon: HiOutlineViewGrid,
        heading: "dekan_sidebar_dashboard",
        link: '/dekan/dashboard',
    },
    {
        icon: PiStudentFill,
        heading: 'dekan_sidebar_users',
        link: '/dekan/students',
    },
    {
        icon: BsFillJournalBookmarkFill,
        heading: 'dean_sidebar_attend',
        link: '/dekan/journal'
    },
    {
        icon: FaClipboardList,
        heading: 'dean_sidebar_results',
        link: '/dekan/results'
    },
    {
        icon: FaLayerGroup,
        heading: 'dekan_sidebar_groupsSettings',
        link: '/dekan/groupsSettings'
    },
    {
        icon: BiSolidReport,
        heading: 'kafedra_sidebar_statement',
        link: '/dekan/statement'
    },
    /*{
        icon: BiMessageDetail,
        heading: 'dekan_sidebar_message',
        link: '/dekan/messages'
    },*/
    {
        icon: FaUsersCog,
        heading: 'dekan_sidebar_staff',
        link: '/dekan/staff'
    },
    {
        icon: MdMiscellaneousServices,
...
export const DeputyDeanSidebarData = [
    {
        icon: HiOutlineViewGrid,
        heading: "dekan_sidebar_dashboard",
        link: '/dekan/dashboard',
    },
    {
        ...
        subNav: [
            {
                path: "/dekan/students/1",
                title: "1 - course",
                course: 1,
            },
            {
                path: "/dekan/students/2",
                title: "2 - course",
                course: 2,
            },
            {
                path: "/dekan/students/3",
                title: "3 - course",
                course: 3,
            },
            {
                path: "/dekan/students/4",
                title: "4 - course",
                course: 4,
            },
        ]
...
export const KafedraSideBar = [
    {
        icon: HiOutlineViewGrid,
        heading: "kafedra_sidebar_dashboard",
        link: '/kafedra/dashboard',
    },
    {
        icon: FiUsers,
        heading: 'kafedra_sidebar_teachers',
        link: '/kafedra/teachers'
    },
    {
        icon: FaUserClock,
        heading: 'kafedra_sidebar_week',
        link: '/kafedra/week'
    },
    {
        icon: BiMessageDetail,
        heading: 'kafedra_sidebar_message',
        link: '/kafedra/messages'
    },
    {
        icon: BiMailSend,
        heading: 'kafedra_sidebar_sms_history',
        link: '/kafedra/smsHistory'
    },
    {
        icon: MdSettings,
        heading: 'student_sidebar_settings',
        link: '/kafedra/settings'
    },
]


export const KafedraSideBarTeachers = [
    {
        icon: HiOutlineViewGrid,
        heading: "kafedra_sidebar_dashboard",
        link: '/kafedra/dashboard',
    ...
    {
        icon: ImBooks,
        heading: 'kafedra_sidebar_subjects',
        link: '/kafedra/subjects'
    },
    {
        icon: FaLayerGroup,
        heading: 'kafedra_sidebar_groupsSubject',
        link: '/kafedra/groupsSubject'
    },
    {
        icon: FaUserClock,
        heading: 'kafedra_sidebar_week',
...
export const BulimSideBar = [
    {
        icon: HiOutlineViewGrid,
        heading: "kafedra_sidebar_dashboard",
        link: '/bulim/dashboard',
    },
    {
        icon: FiUsers,
        heading: 'bulim_sidebar_staffs',
        link: '/bulim/staffs'
    },
    {
        icon: MdSettings,
...
export const BoshqarmaSideBar = [
    {
        icon: HiOutlineViewGrid,
        heading: "kafedra_sidebar_dashboard",
        link: '/boshqarma/dashboard',
    },
    {
        icon: MdDashboard,
        heading: "boshqarama_education",
        link: "/boshqarma/education"
    },
    {
        icon: FaUsers,
        heading: "trainingdivision_sidebar_groups",
        link: "/boshqarma/groups"
    },
    {
        icon: FaChalkboardTeacher,
        heading: "trainingdivision_sidebar_teachertimetable",
        link: "/boshqarma/teachers",
    },
    {
        icon: BsDoorOpenFill,
        heading: "trainingdivision_sidebar_roomstimetable",
        link: "/boshqarma/rooms"
    },
    {
        icon: ImStatsDots,
        heading: "trainingdivision_sidebar_report",
        link: "/boshqarma/report"
    },
    {
        icon: FiUsers,
        heading: 'bulim_sidebar_staffs',
        link: '/boshqarma/staffs'
    },
    {
        icon: MdSettings,
        heading: 'student_sidebar_settings',
        link: '/boshqarma/settings'
    },
]
...
export const MonitoringAssistantSideBar = [
    {
        icon: FaClipboardList,
        heading: "trainingdivision_sidebar_rating_students",
        link: '/monitoringAssistant/rating'
    },
]


export const UquvBulimiSidebar = [
    {
        icon: MdDashboard,
        heading: "trainingdivision_sidebar_dashboard",
        link: "/uquv/dashboard"
    },
 {
        icon: FaRegCalendarAlt,
        heading: "trainingdivision_sidebar_eduYear",
        link: "/uquv/eduYear"
    },
   /* {
        icon: ImStatsDots,
    ...
    {
        icon: IoTime,
        heading: "trainingdivision_sidebar_timetable",
        link: "/uquv/timetable"
    },
    {
        icon: BiSolidReport,
    ...
    {
        icon: BsFillJournalBookmarkFill,
        heading: "trainingdivision_sidebar_change_log",
        link: "/uquv/changeLog",
    },
    {
        icon: FaClipboardList,
    ...
    {
        icon: FaUserTie,
        heading: "trainingdivision_sidebar_dean",
        link: "/uquv/deans",
    },
 {
        icon: FaUserGroup,
        heading: "trainingdivision_sidebar_teachers",
        link: "/uquv/teachers",
    },
    {
        icon: BiSolidUser,
        heading: "trainingdivision_sidebar_assistant",
        link: "/uquv/assistant",
    },
    {
        icon: PiStudent,
        heading: "trainingdivision_sidebar_students",
        link: "/uquv/students",
    },
]
...
export const AdminSidebar = [
    {
        icon: MdMenuBook,
        heading: "admin_sidebar_menu",
        link: "/admin/menu"
    },
    {
        icon: FaUserCog,
        heading: "admin_sidebar_user",
        link: "/admin/user"
    },
    {
        icon: BsFillDoorOpenFill,
        heading: "admin_sidebar_rooms",
        link: "/admin/rooms"
    },
    {
        icon: MdDevices,
        heading: "admin_sidebar_device",
        link: "/admin/device"
    },
    {
        icon: FaRegBuilding,
        heading: "admin_sidebar_buildings",
